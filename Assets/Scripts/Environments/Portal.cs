...
public class Portal : MonoBehaviour
{
    ...
    public void SwitchExit(Portal newExit)
    {
        newExit.enabled = true;
        _LinkedPortal.enabled = false;
        _LinkedPortal.ResetViewtTexture();
        _LinkedPortal._LinkedPortal = null;
        _LinkedPortal = newExit;
        newExit._LinkedPortal = this;
        newExit.ResetViewtTexture();
        ResetViewtTexture();
    }
}